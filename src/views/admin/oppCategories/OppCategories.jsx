...
import {
  ...
  delAsync,
  filter,
} from "../../../redux/oppCategories/oppCategories.slice";
...
const OppCategories = () => {
  ...
  const isLoading = useSelector((state) => state.oppCategories.isLoading);
  const oppCategories = useSelector(
    (state) => state.oppCategories.oppCategories
  );
  ...
  const openEditModal = (id) => {
    setEditItem(oppCategories.find(({ _id }) => id === _id));
    ...
    >
      ...
      <DialogContent>
        <DialogContentText id="alert-dialog-description">
          If you delete an opportunity category, all the opportunities that fall
